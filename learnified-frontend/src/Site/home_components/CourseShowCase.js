...
//       <div className="flex justify-center items-center flex-col gap-5 lg:py-44 py-5 px-5">
//         {loading ? (
//           <>
//             <Skeleton />
//             <Skeleton />
...
//               }}
//               key={idx}
//               className="h-screen relative group lg:h-40 lg:hover:h-56 transition-all rounded-2xl border-gray-300 border-[3px] hover:border-purple-500 text-black container mx-auto hover:shadow-lg cursor-pointer px-10 flex lg:justify-center flex-col lg:flex-row lg:items-center"
//             >
//               <div className="bg-purple-300 text-5xl px-5 py-5 rounded-lg font-bold w-min my-10">
...
//                   </p>
//                   <p className="text-3xl  px-3 py-1 w-min whitespace-nowrap text-gray-700 font-bold rounded-full">
//                     {item.description}
//                   </p>
//                 </div>
//               </div>
...
//                 alt="course"
//                 className="lg:group-hover:absolute anim lg:group-hover:block lg:absolute lg:hidden lg:right-28"
//               />
